...
export default defineConfig({
  ...
  test: {
    ...
    exclude: ["node_modules", "dist", "opensrc/**", "repos/**", "signoz/**", ".context/**"],
  ...
  fmt: {
    printWidth: 120,
    ignorePatterns: ["node_modules", "dist", "repos", "**/routeTree.gen.ts", "signoz/**", ".context/**/*"],
    singleQuote: false,
  ...
  lint: {
    ...
    rules: {
      ...
      "use-isnan": "warn",
      "valid-typeof": "warn",
      "effect-inngest/prefer-option-from-nullable": "warn",
      "effect-inngest/no-global-error-in-effect-fail": "error",
      "effect-inngest/no-global-fetch": "error",
      "effect-inngest/prefer-predicate-has-property": "error",
